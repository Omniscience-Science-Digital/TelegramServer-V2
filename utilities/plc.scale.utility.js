const { plcScaleFlow, ActualPlcEnd, ActualPlcStart, runtimeAccumulatingPlcFlow, runtimePlcFlow } = require('../repositories/postgress_repository');
const { calculateTotalHours, addTwoHours } = require("./time.utility");


async function plcScaleCalcsFunc( shifts_Ran, monthstart, shift, startTime, endTime, startdate, enddate, plcFlow, runningtph, maxUtilization, scales, primaryScalesArray, plcIccid) {
    try {
...
module.exports = { plcScaleCalcsFunc }
